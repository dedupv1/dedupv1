...
#ifndef TRACE_MONITOR_H__
#define TRACE_MONITOR_H__
 ...
 * \ingroup monitor
 */
class TraceMonitorAdapter : public DefaultMonitorAdapter {
    private:
     ...
     * @return
     */
    explicit TraceMonitorAdapter(dedupv1d::Dedupv1d* ds);
