...
/**
 * Monitor to show all available monitor names
 *
 * \ingroup monitor
 */
class MonitorMonitorAdapter : public DefaultMonitorAdapter {
    private:
    /**
     ...
     * @return
     */
    explicit MonitorMonitorAdapter(dedupv1d::Dedupv1d* ds);
