...
const CommandHandlerStatsData& CommandHandlerStatsData::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_dedupv1d_5fstats_2eproto();
