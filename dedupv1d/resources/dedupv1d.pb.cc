...
const ::std::string OptionPair::_default_option_name_;
const ::std::string OptionPair::_default_option_;
#ifndef _MSC_VER
...
const OptionPair& OptionPair::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_dedupv1d_2eproto();  return *default_instance_;
}
...
const ::std::string VolumeInfoData::_default_device_name_;
#ifndef _MSC_VER
...
void VolumeInfoData::SharedCtor() {
  _cached_size_ = 0;
  volume_id_ = 0u;
  device_name_ = const_cast< ::std::string*>(&_default_device_name_);
...
const ::std::string CommandErrorReportData::_default_details_;
#ifndef _MSC_VER
...
const ::std::string VolumeInfoDetachingData::_default_former_device_name_;
#ifndef _MSC_VER
...
void VolumeInfoDetachingData::SharedCtor() {
  _cached_size_ = 0;
  volume_id_ = 0u;
  former_device_name_ = const_cast< ::std::string*>(&_default_former_device_name_);
...
const ::std::string GroupInfoData::_default_group_name_;
#ifndef _MSC_VER
...
void GroupInfoData::SharedCtor() {
  _cached_size_ = 0;
  group_name_ = const_cast< ::std::string*>(&_default_group_name_);
  ::memset(_has_bits_, 0, sizeof(_has_bits_));
}
      ...
      case 2: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
         ...
         parse_initiator_pattern:
          ...
          ::google::protobuf::internal::WireFormat::VerifyUTF8String(
            this->initiator_pattern(0).data(), this->initiator_pattern(0).length(),
            ::google::protobuf::internal::WireFormat::PARSE);
        } else {
          goto handle_uninterpreted;
        }
...
const ::std::string TargetAuthData::_default_username_;
const ::std::string TargetAuthData::_default_secret_;
#ifndef _MSC_VER
...
const ::std::string TargetInfoData::_default_target_name_;
#ifndef _MSC_VER
...
void TargetInfoData::SharedCtor() {
  _cached_size_ = 0;
  target_name_ = const_cast< ::std::string*>(&_default_target_name_);
  tid_ = 0u;
  auth_ = NULL;
  ::memset(_has_bits_, 0, sizeof(_has_bits_));
}
...
const ::std::string UserInfoData::_default_user_name_;
const ::std::string UserInfoData::_default_secret_;
#ifndef _MSC_VER
...
const ::std::string DirtyFileData::_default_config_;
const ::std::string DirtyFileData::_default_revision_;
#ifndef _MSC_VER
...
void DirtyFileData::SharedCtor() {
  ...
  stopped_ = false;
  revision_ = const_cast< ::std::string*>(&_default_revision_);
  ::memset(_has_bits_, 0, sizeof(_has_bits_));
}
