...
const DiskHashIndexLogfileData& DiskHashIndexLogfileData::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_dedupv1_5fbase_2eproto();  return *default_instance_;
}
...
const ::std::string DiskHashTransactionPageData::_default_data_;
#ifndef _MSC_VER
...
const ::std::string FixedIndexBucketData::_default_data_;
const ::std::string FixedIndexBucketData::_default_crc_bytes_;
#ifndef _MSC_VER
...
void FixedIndexBucketData::SharedCtor() {
  ...
  data_ = const_cast< ::std::string*>(&_default_data_);
  state_ = 0;
  crc_bytes_ = const_cast< ::std::string*>(&_default_crc_bytes_);
  crc_ = 0u;
  ::memset(_has_bits_, 0, sizeof(_has_bits_));
}
...
const ::std::string BitmapPageData::_default_data_;
#ifndef _MSC_VER
...
const ::std::string RawByteData::_default_raw_value_;
#ifndef _MSC_VER
...
void RawByteData::SharedCtor() {
  _cached_size_ = 0;
  raw_value_ = const_cast< ::std::string*>(&_default_raw_value_);
  ::memset(_has_bits_, 0, sizeof(_has_bits_));
}
